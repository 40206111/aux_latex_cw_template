%FILL THESE IN
\def\mytitle{Collisions Coursework Report}
\def\mykeywords{Collisions, OBB, Collider, Impulse}
...
\begin{document}
	\maketitle
	\begin{abstract}
		Creating sphere and box colliders and having them react to themselves and each other in a scene.
	\end{abstract}
